...
// Structured as ["ItemName", HPToHeal]
...
soul_spr = SOULs;
soul_x = -100; // This will be updated on the first frame if state isn't changed
soul_y = -100;
...
arena_width = 565; // Note: these are based off of INNER WIDTH!!!
arena_height = 130;
target_arena_width = 565;
target_arena_height = 130;
resizing_state = "DONE";
arena_speed = 30; // 15 px per frame, measurement taken from Sans fight

arena_thickness = 4; // This is 4 because of how GameMaker draws rectangles
					 // it's actually 5
                     // Note: This is EXTREMELY buggy. I wouldn't change this value.
arena_color = #ffffff;
...
//blueSoulInstance = instance_create_depth(arena_center_x, arena_center_y, -9997, blueSoulController);
soulmode = 0;
...
krCon = instance_create_depth(-100, -100, -9999, krController);
